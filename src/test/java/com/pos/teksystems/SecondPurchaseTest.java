...
public class SecondPurchaseTest {
    ...
    public void setup() {
        ...
        importedFood = ImportedGood.builder().price(new BigDecimal(IMPORTED_FOOD_PRICE)).name("1 box of chocolates").category(new ImportedFoods()).build();
        ...
        purchase = new Purchase("Purchase #2");
